...
Read [the Acta artifact protocol](references/acta-protocol.md) and use [the Explore scaffold](references/acta-scaffold.html). This skill uses a user-selected durable workspace rather than `.agent-work`.
